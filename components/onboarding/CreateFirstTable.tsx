...
const CreateFirstTable: React.FC<CreateWorkspaceProps> = ({ workspaceName, setWorkspaceName }: { workspaceName: string, setWorkspaceName: React.Dispatch<React.SetStateAction<string>> }) => {
